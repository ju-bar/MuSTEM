...
set LIBS=cufft.lib
set OPTS=-Mpreprocess -DGPU -Ddouble_precision -Bstatic -Mbackslash -Mfree -mp -Mcuda=cuda10.1,ccall -fast -tp=k8-64e,piledriver,penryn,sandybridge,haswell -Minform=warn -O3
set OBJDIR=x64\objgpu
set OUTDIR=x64\Release
set OUTNAME=muSTEM_GPU_double
set COMPILEDFILES=0
set MAKEALL=0
