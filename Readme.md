...
In recent year, Juri Barthel has contributed significantly to the development of μSTEM, in particular regarding plasmon scattering, the secondary electron imaging model, improved flexibility of the STEM EELS simulation, and improved performance of the transition potential code in STEM simulations. Also Juri corrected mistakes and also reformatted and commented large parts of the code, especially where it appeared very cluttered and was quite challenging to interprete.
